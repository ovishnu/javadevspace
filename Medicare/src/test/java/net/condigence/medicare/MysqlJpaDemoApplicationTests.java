...
//		// Game pandemic = new Game("Pandemic", "Co-op game for wannabe disease
//		// control specailists");
//		// Game werewolf = new Game("Werewolf", "You must find out who's
//		// secretly the werewolf, before it's too late");
//		// Game camelUp = new Game("Camel Up", "A high stakes game of gambling
//		// and camel racing");
...
//		// assertEquals("Found wrong number of Camel Ups", 1,
//		// camelUpList.size());
//		// assertEquals("Found wrong name", "Camel Up",
//		// camelUpList.get(0).getName());
//	}
//
//	@Test
...
//		// assertEquals("Did not find Munchkin", munchkin.getName(),
//		// foundGame.get(0).getName());
//		//
//		// // Edit it's description
//		// String newDescription = "If you love rules that change, you'll love
//		// Munchkin!";
//		// foundGame.get(0).setDescription(newDescription);
//		//
//		// // Save to the database (note that we can save not just single
//		// Entities,
//		// // but collections of them as well)
//		// gameRepository.save(foundGame);
//		//
//		// // Assert it updated
//		// List<Game> updatedGame =
//		// gameRepository.findByName(munchkin.getName());
//		// assertEquals("Did not update description", newDescription,
//		// updatedGame.get(0).getDescription());
//		//
//		// // Delete game
